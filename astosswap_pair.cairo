...
from libraries.AstosSwap_library import min_uint256
...
func initialize{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    ...
    let (sender) = get_caller_address()
    with_attr error_message("AstosSwap: FB"):
    ...
    ERC20.initializer('AstosSwap Pair Token', 'LPT', 18)
...
func burn{
    ...
    with_attr error_message("AstosSwap: ILB"):
...
func swap{
    ...
    with_attr error_message("AstosSwap: IOA"):
    ...
    with_attr error_message("AstosSwap: IL"):
    ...
    # Invalid to
    with_attr error_message("AstosSwap: IT"):
        if to == token0:
            assert 1 = 0
        end
        if to == token1:
    ...
    with_attr error_message("AstosSwap: IIA"):
    ...
    with_attr error_message("AstosSwap: K"):
...
func _mint_part1{
    ...
    with_attr error_message("AstosSwap: ILM"):
...
func _update{
    ...
    # Overflow
    with_attr error_message("AstosSwap: OV"):
...
func _mintFee{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    ...
    let (feeTo) = IAstosSwapFactory.feeTo(contract_address=factory)
