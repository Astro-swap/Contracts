...
namespace AstosSwapLibrary:
    ...
    func sortTokens{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        ...
        # Identical addresses
        with_attr error_message("AstosSwap: IA"):
        ...
        if is_le == TRUE:
            # Zero address
            with_attr error_message("AstosSwap: ZA"):
    ...
    func quote{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        ...
        # Insufficient amount
        with_attr error_message("AstosSwapLibrary: IA"):
            let (is_le) = uint256_le(amountA, Uint256(0, 0))
            assert is_le = FALSE
        end

        # Insufficient liquidity
        with_attr error_message("AstosSwapLibrary: IL"):
    ...
    func getAmountOut{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        ...
        with_attr error_message("AstosSwapLibrary: IIA"):
    ...
    func getAmountIn{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        ...
        with_attr error_message("AstosSwapLibrary: IOA"):
    ...
    func getAmountsOut{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        ...
        # Invalid_path
        with_attr error_message("AstosSwapLibrary: IP"):
